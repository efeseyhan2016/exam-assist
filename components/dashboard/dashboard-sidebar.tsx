      ...
      <div className="flex h-full flex-col overflow-y-auto p-3.5">
        <div>
          <div className="flex items-center justify-between gap-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-1 text-[10px] uppercase tracking-[0.18em] text-slate-300">
          ...
          <h2 className="mt-2.5 text-lg font-semibold text-white">
        ...
        <div className="mt-4 rounded-[20px] border border-white/8 bg-black/20 p-3.5">
          <p className="text-[11px] uppercase tracking-[0.14em] text-slate-400">
            Anlık durum
          </p>
        ...
        <div className="mt-auto space-y-2 pt-3">
          <button
            type="button"
            onClick={onLogout}
            className="flex w-full items-center gap-2 rounded-[16px] border border-white/8 bg-white/[0.02] px-3.5 py-2.5 text-sm text-slate-500 transition hover:border-sky-400/20 hover:bg-sky-400/[0.04] hover:text-sky-300"
          >
          ...
          <button
            type="button"
            onClick={onReset}
            className="flex w-full items-center gap-2 rounded-[16px] border border-white/8 bg-white/[0.02] px-3.5 py-2 text-xs text-slate-600 transition hover:border-rose-400/20 hover:bg-rose-400/[0.04] hover:text-rose-400"
          >
